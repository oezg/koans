...
-export([dictionaries_give_the_definition_of_a_key/0, append_assumes_something/0,
         fetching_what_is_not_available_is_troublesome/0, however_find_is_a_bit_safer/0,
         find_reports_on_matches/0, erasing_from_a_dict/0, size_is_relative/0]).
