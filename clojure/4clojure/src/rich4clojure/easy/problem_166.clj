...
(defn comparison
  "Write a function that takes three arguments, a less than operator
   for the data and two items to compare. The function should return
   a keyword describing the relationship between the two items."
  [lt? item1 item2]
  (cond
    (lt? item1 item2) :lt
    (lt? item2 item1) :gt
